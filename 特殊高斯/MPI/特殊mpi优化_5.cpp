...
#define num_columns 2362
#define num_elimination_rows 1226
#define num_eliminated_rows 453
...
int main(int argc, char *argv[]) {
    ...
    if (rank == 0) {
        ...
        ifstream file_R;
        char buffer[10000] = {0};
        file_R.open("/home/data/Groebner/5_2362_1226_453/1.txt");
        if (file_R.fail()) {
            cout << "读入失败" << endl;
        }
        ...
        // 读入被消元行
        ifstream file_E;
        file_E.open("/home/data/Groebner/5_2362_1226_453/2.txt");
