...
#define num_columns 8399
#define num_elimination_rows 6375
#define num_eliminated_rows 4535
...
int main() {
    ...
    file_R.open("/home/data/Groebner/7_8399_6375_4535/1.txt");
    if (file_R.fail()) {
        cout << "读入失败" << endl;
    }
...
//--------------------------------
    ...
    file_E.open("/home/data/Groebner/7_8399_6375_4535/2.txt");
